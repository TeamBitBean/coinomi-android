...
import com.coinomi.core.coins.BitbeanMain;
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
	...
	COINS_ICONS.put(CoinID.BITBEAN_MAIN.getCoinType(), R.drawable.bitbean);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
	...
	COINS_BLOCK_EXPLORERS.put(CoinID.BITBEAN_MAIN.getCoinType(), "https://chains.cryptoid.info/bitb/tx.dws?%s");
    }
